...
-- FULL VERSION - Includes database creation
-- NOTE: Only use this if you need to create the database
-- For FreeSQLDatabase, the database already exists, so use SQL_TO_RUN_IN_PHPMYADMIN.sql instead

-- Create database (only if it doesn't exist)
CREATE DATABASE IF NOT EXISTS marketing_pwa CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
